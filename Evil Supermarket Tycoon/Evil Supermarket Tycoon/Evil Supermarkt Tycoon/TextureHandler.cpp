...
void TextureHandler::LoadTextures()
{
	...
	while(std::getline(file2, line))
	{
		...
		while (anotheriter != this->Sprites.end())
		{
			...
			{
				anotheriter->Sprite.setScale(atof(scaleX.c_str()), atof(scaleY.c_str()));
				anotheriter->Origins[0] = sf::Vector2f(atoi(orig1X.c_str()), atoi(orig1Y.c_str()));
				anotheriter->Origins[1] = sf::Vector2f(atoi(orig2X.c_str()), atoi(orig2Y.c_str()));
				anotheriter->Origins[2] = sf::Vector2f(atoi(orig3X.c_str()), atoi(orig3Y.c_str()));
				anotheriter->Origins[3] = sf::Vector2f(atoi(orig4X.c_str()), atoi(orig4Y.c_str()));
			}
			anotheriter++;
		}
	}
