...
{
	this->EmotionState = std::min(this->Happiness * 6, 5.0f);
	...
	if (this->EmoticonTimer < 1.5f)
	{
		...
		this->Emoticons[0][this->EmotionState]->setColor(sf::Color(255, 255, 255, scale * 255.0f));
	}
	...
	{
		this->Emoticons[0][this->EmotionState]->setColor(sf::Color(255, 255, 255, (6.0f - this->EmoticonTimer) * 255.0f));
	}
	else
	{
