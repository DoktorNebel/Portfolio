...
{
	this->Value = value;
	this->FillSprite->setTextureRect(sf::IntRect(this->FillSprite->getTextureRect().left, this->FillSprite->getTextureRect().top,this->Sprite->getTextureRect().width * this->Value, this->FillSprite->getTextureRect().height));
}
