...
namespace The_Secret_Castle
{
    public class GameObject
    {
        ...
        public void Update(Character player, List<GameObject> objects, List<Link> links, Operation colCheck, GameTime gameTime, Texture2D cursor, OperationTwo colCheckTwo)
        {
            if (Type == 12)
            {
