...
namespace TSC_Game
{
    public class GameCamera
    {
        ...
        public void Update(GameCharacter player, GraphicsDevice graphics, Texture2D backGround)
        {
            Vector2 pos = -player.Position + new Vector2(graphics.Viewport.Width / 2, graphics.Viewport.Height / 2);
